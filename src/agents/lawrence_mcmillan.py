...
class LawrenceMcMillanSignal(BaseModel):
    ...
    reasoning: str = Field(..., description="A holistic analysis combining put-call ratios, open interest, and structural market view, per McMillan.")
    expected_holding_days: int = Field(default=20)
